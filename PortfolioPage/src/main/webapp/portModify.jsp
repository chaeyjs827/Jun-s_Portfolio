...
<body>
	...
	<div id="section">
		<div class="container">
			<form class="form-horizontal" id="postForm" role="form" method="post" action="./updatePost.do?bt=${bt}&cp=${cp}&pi=${pi}" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="title" name="title" value="${blist.title}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="writer" name="writer" value="${blist.writer}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" id="startedDate" name="startedDate" value="${blist.startedDate}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" id="finishedDate" name="finishedDate" value="${blist.finishedDate}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="4" id="summary" name="summary">${blist.summary}</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="4" id="usingSkill" name="usingSkill">${blist.usingSkill}</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="4" id="content" name="content">${blist.content}</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="gitUrl" name="gitUrl" placeholder="enter git URL" value="${blist.gitUrl}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="serverUrl" name="serverUrl" placeholder="enter server URL" value="${blist.serverUrl}">
					</div>
				</div>
